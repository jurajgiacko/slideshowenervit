...
export default function B2BProgramSlide({ locale }: Props) {
  const content = t(locale, 'b2b_program');
    ...
    <div className="slide bg-[var(--slide-bg)] text-white">
      <div className="slide-content">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-emerald-400 text-sm font-semibold uppercase tracking-widest">B2B Program</span>
        </div>
